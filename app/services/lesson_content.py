...
class LessonContentService:
    PROMPT_VERSION = "lesson_content_v2"
    ...
    def generate(
        ...
        *,
        ...
        instructions = (
            ...
            "Make checkpoint distractors diagnose likely misunderstandings."
        )
    ...
    def _build_prompt(
        ...
        *,
        ...
        return (
            ...
            "- The checkpoint should test understanding of the current section, not trivia.\n"
